...
Phase pipeline::
    ...
    units = build_partition_units(inventory, config=...)  # weights
    manifest = partition_source(roots, workers=N, config=...)  # full pipeline
...
from strix.tools.source_partition.partition import partition_source
